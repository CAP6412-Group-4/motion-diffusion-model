...
def setup_params():
    ...
    return args, model, model_kwargs, 0, diffusion, n_frames, data, all_motions, all_lengths, all_text




def generate_sample(args, model, model_kwargs, rep_i, diffusion, n_frames, data, all_motions, all_lengths, all_text):
